...
#+begin_example
✔ | OK F W S | Context
⠏ |  0       | Control behavior according to dattype⠋ |  1       | Control behavior according to dattype⠙ |  2       | Control behavior according to dattype⠹ |  3       | Control behavior according to dattype⠸ |  4       | Control behavior according to dattype⠼ |  5       | Control behavior according to dattype⠴ |  6       | Control behavior according to dattype⠦ |  7       | Control behavior according to dattype⠧ |  8       | Control behavior according to dattype⠇ |  9       | Control behavior according to dattype⠏ | 10       | Control behavior according to dattype⠋ | 11       | Control behavior according to dattype⠙ | 12       | Control behavior according to dattype⠹ | 13       | Control behavior according to dattype⠸ | 14       | Control behavior according to dattype⠼ | 15       | Control behavior according to dattype⠴ | 16       | Control behavior according to dattype⠦ | 17       | Control behavior according to dattype⠧ | 18       | Control behavior according to dattype⠇ | 19       | Control behavior according to dattype⠏ | 20       | Control behavior according to dattype⠋ | 21       | Control behavior according to dattype⠙ | 22       | Control behavior according to dattype⠹ | 23       | Control behavior according to dattype⠸ | 24       | Control behavior according to dattype✔ | 24       | Control behavior according to dattype
...
** 関数
*** ヘルパー関数
#+BEGIN_SRC R :tangle otolithr/R/util.R :results silent
  #' @importFrom magrittr %>%
  #' @export
  magrittr::`%>%`
...
*** hdr 読み込み
#+BEGIN_SRC R :tangle otolithr/R/handle_hdr.R :results silent
...
*** 統合関数
#+BEGIN_SRC R :tangle otolithr/R/load_otolith.R :results silent
